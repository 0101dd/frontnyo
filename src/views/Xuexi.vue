...
<v-app style="overflow: hidden;">
  <div id="xuexi">
    ...
    <div
      ...
      <div class="row">
        <div class="col-md-6 col text-center text-sm-left">
          <h3>筆畫寫不到位</h3>
          <h4>塗描結合</h4>
      ...
      <div class="row">
        <div class="col-md-6 col text-center text-sm-left">
          <h3>看一筆寫一筆</h3>
          <h4>光臨不背</h4>
          <p class="mt-5">學習者多習楷書，楷書筆畫雖各自獨立，但筆畫之間，還是有聯繫的。比如，一筆寫完再寫下一筆時，筆在空中有個走動的線路，同時形成下一筆逆勢，這個逆勢就是下一筆的藏鋒動作，也叫借勢落筆，可省藏鋒動作，能使筆畫自然協調。因此對字帖中較熟悉的字，可先看兩筆或三筆，連續寫兩筆或三筆，直到過渡到一次就能寫出一個完整的字來。</p>
        </div>
      </div>
    </div>
    </div>
