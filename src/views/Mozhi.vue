  ...
  <div id="mozhi">
    ...
    <div
      ...
      <div class="row" style="margin-top: 200px;">
        <div class="col-sm-12 col-12 text-center text-sm-left t1 my-auto">
          <h3>墨的淡與濃</h3>
          <p class="mt-5">墨與水是相容的，墨需有水才能流暢，太濃太乾則易成枯筆，水枯則行筆澀度高，功夫要更高才行。所以，太濃時就要加些水，再拌均勻就好寫了。但水要少量慢加，若加太多水就太淡了，字就容易渲開暈散，反而更難看。</p>
        </div>
        <v-spacer></v-spacer>
         <div class="col-sm-12 col-12 t1" style="height: 90%; overflow: hidden;">
          <img
            src="../assets/mo-1.jpg"
          >
        </div>
      ...
      <div class="row" style="margin-top: 200px;">
         <div class="col-sm-12 col-12 t2" style="height: 100%; overflow: hidden;">
          <img
            src="../assets/mo-2.jpg"
          >
        </div>
      ...
      <div class="row" style="margin-top: 200px;">
        ...
        <v-spacer></v-spacer>
        <div class="col-sm-12 col-12 t3" style="height: 50%; overflow: hidden;">
          <img
            src="../assets/mo-3.jpg"
          >
        </div>
      ...
      <div class="row" style="margin-top: 200px;">
        <div class="col-sm-12 col-12 t4" style="height: 50%; overflow: hidden;">
          <img
            src="../assets/mo-4.jpg"
          >
        </div>
      ...
      <div class="row flex-column flex-sm-row">
        ...
        <div class="row">
          ...
          <p>3. 冬季凝凍是傳統墨汁的特性，所以應在高於10℃的室內存放。如果凝凍，可以用溫水浸泡瓶身即可融化，質量如初。</p>
          <p class="mb-16">4. 千萬別將墨汁沾在衣服上，否則很難徹底清洗乾淨。</p>
        </div>
      </div>
    </div>
  </div>
