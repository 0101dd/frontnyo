  ...
  <div id="mozhi">
    ...
    <div
      ...
      <div class="row" style="margin-top: 200px;">
        <div class="col-md-5 col text-center text-sm-left t1 my-auto">
          <h3>墨的淡與濃</h3>
          <p class="mt-5">墨與水是相容的，墨需有水才能流暢，太濃太乾則易成枯筆，水枯則行筆澀度高，功夫要更高才行。所以，太濃時就要加些水，再拌均勻就好寫了。但水要少量慢加，若加太多水就太淡了，字就容易渲開暈散，反而更難看。</p>
        </div>
        <v-spacer></v-spacer>
         <div class="col-sm-6 col-12 t1" style="height: 90%; overflow: hidden;">
          <img
            src="../assets/mo-1.jpg"
          >
        </div>
      ...
      <div class="row" style="margin-top: 200px;">
         <div class="col-sm-6 col-12 t2" style="height: 100%; overflow: hidden;">
          <img
            src="../assets/mo-2.jpg"
          >
        </div>
      ...
      <div class="row" style="margin-top: 200px;">
        ...
        <v-spacer></v-spacer>
        <div class="col-sm-6 col-12 t3" style="height: 50%; overflow: hidden;">
          <img
            src="../assets/mo-3.jpg"
          >
        </div>
      ...
      <div class="row flex-column flex-sm-row">
        ...
        <div class="row">
          <div class="mx-auto col-sm-6 col text-center">
          <h3>注意項目</h3>
